...
class ShuleStaffPolicy extends ShuleBasePolicy
{
    ...
    public function view(User $user, ShuleStaff $staff): bool
    {
        return $this->can($user, 'staff.view');
    }
    ...
    public function update(User $user, ShuleStaff $staff): bool
    {
        return $this->can($user, 'staff.manage');
    }

    public function delete(User $user, ShuleStaff $staff): bool
    {
        return $this->can($user, 'staff.manage');
    }
}
