...
class SeniorsStudentDashboardScreen extends StatefulWidget {
  const SeniorsStudentDashboardScreen({super.key});

  @override
  State<SeniorsStudentDashboardScreen> createState() => _SeniorsStudentDashboardScreenState();
}

class _SeniorsStudentDashboardScreenState extends State<SeniorsStudentDashboardScreen> {
  int _courseSubTab = 0;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const K1TopBar(title: 'Shule Yetu ', subtitle: 'Student', dark: true, mailBadge: 1),
          const SizedBox(height: 8),
          Text(data.studentName, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 16)),
